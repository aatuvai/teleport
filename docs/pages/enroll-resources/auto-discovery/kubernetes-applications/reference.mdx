...
please see [helm chart documentation](../../../reference/helm-reference/teleport-kube-agent.mdx).
...
For more information you can take a look at [`discovery_service`](../../../reference/deployment/config/config.mdx) and [`app_service`](../../../reference/deployment/config/config.mdx) configuration references.
