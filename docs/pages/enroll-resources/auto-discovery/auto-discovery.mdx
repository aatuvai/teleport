  ...
  ctaLinks={[
    {
      ...
      href: "./kubernetes-applications/get-started/",
      variant: "secondary",
      arrow: true,
    },
  ]}
...
[Teleport Agents](../../reference/architecture/agents.mdx) power the discovery service, automatically syncing resources with the Auth Service.
</DocHero>
