...
<Checkpoint 
  title="Verify your server enrollment" 
  description="Make sure your Ubuntu server appears in the Teleport Web UI under Resources and that you can connect to it via SSH."
  successButtonText="Yes, I was able to connect!"
  failureButtonText="No, there was a problem."
>
  Here are some troubleshooting tips:
  - **Server not showing up?** Ensure the Teleport Agent is running on your Ubuntu server.
  - **Connection issues?** Double-check network connectivity and firewall settings between your Teleport cluster and the Ubuntu server.
  - **Still stuck?** Reach out to our [Slack community](https://goteleport.com/slack) or [customer support](https://goteleport.com/support/) for help.
</Checkpoint>
