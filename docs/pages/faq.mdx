...
<Tabs>
  <TabItem label="General FAQ">
    ...
    <details open neutral>
    <summary>Can I use Teleport in production today?</summary>
    ...
    <details open neutral>
    <summary>Can I connect to nodes behind a firewall?</summary>
    ...
    <details open neutral>
    <summary>How is Teleport's Community Edition different from Enterprise?</summary>
    ...
    <details open neutral>
    <summary>Should we use Teleport Enterprise or Teleport Community Edition for connecting resources to our Teleport cluster?</summary>
  ...
  <TabItem label="Cloud FAQ">
    <details open neutral>
    <summary>Can individual agents create reverse tunnels to the Proxy Service without creating a new cluster?</summary>
    ...
    <details open neutral>
    <summary>Can Nodes use a single port for reverse tunnels?</summary>
    ...
    <details open neutral>
    <summary>Can Teleport be deployed in agentless mode?</summary>
    ...
    <details open neutral>
    <summary>Can I use OpenSSH with a Teleport cluster?</summary>
    ...
    <details open neutral>
    <summary>Can I copy files from one Teleport node to another?</summary>
    ...
    <details open neutral>
    <summary>`tsh` is very slow on Windows, what to do?</summary>
    ...
    <details open neutral>
    <summary>Which version of Teleport is supported?</summary>
    ...
    <details open neutral>
    <summary>Does the Web UI support copy and paste?</summary>
    ...
    <details open neutral>
    <summary>What TCP ports does Teleport use?</summary>
    ...
    <details open neutral>
    <summary>Does Teleport support authentication via OIDC, SAML, or Active Directory?</summary>
    ...
    <details open neutral>
    <summary>Why do changes to a user's role set only take effect on the next login?</summary>
    ...
    <details open neutral>
    <summary>Does Teleport support provisioning users via SCIM?</summary>
    ...
    <details open neutral>
    <summary>Why do I see an alert that some agents are out of date?</summary>
    ...
    <details open neutral>
    <summary>What is the minimum TLS version that Teleport requires?</summary>
    ...
    <details open neutral>
    <summary>Can I suppress warnings about available upgrades?</summary>
    ...
    <details open neutral>
    <summary>Does Teleport send any data back to the cloud?</summary>
