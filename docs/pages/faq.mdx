...
by configuring [group filters](./identity-governance/integrations/entra-id/advanced-options.mdx#group-filters). 
...
See the available [guides](enroll-resources/database-access/guides/guides.mdx) for all supported configurations.
...
[Proxy Configuration](enroll-resources/database-access/reference/configuration.mdx) for
more details.
...
[configuration file](enroll-resources/database-access/reference/configuration.mdx)
...
See [labels reference](enroll-resources/database-access/reference/labels.mdx) for a full list of Teleport
...
Check out the
[Kubernetes Service Standalone Guide](enroll-resources/kubernetes-access/register-clusters/static-kubeconfig.mdx).
...
Check out the [Teleport Kubernetes RBAC Guide](enroll-resources/kubernetes-access/controls.mdx) for
...
Check out the [Kubernetes Service Discovery Guide](enroll-resources/auto-discovery/kubernetes/kubernetes.mdx) for more
