...
description: Learn how Infrastructure as Code (IaC) integrates with Teleport.
tags:
...
## B. Configuration resources that apply to static configuration field
...
## D. Dynamic resource references

Read the following reference guides for comprehensive lists of supported fields in Teleport dynamic resources:

- ### tctl resources
  For reference guides to dynamic configuration resources available to apply using tctl, read the Configuration Resource Reference. There are also dedicated configuration resource references for applications and databases.
...
- ### Kubernetes operator resources
  For comprehensive reference guides for resources you can manage with the Kubernetes operator, see Teleport Kubernetes Operator Resource References.