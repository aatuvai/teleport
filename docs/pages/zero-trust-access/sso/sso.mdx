---
title: Teleport Single Sign-On Integrations
...
To get started integrating your identity provider with Teleport, read <InlineCTA href="./integrate-idp/" imageName="ssoIntegrations">Integrate
your Identity Provider</InlineCTA>

## A. How Teleport uses SSO
