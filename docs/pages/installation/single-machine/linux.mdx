...
our [Self-Hosting
Teleport](../self-hosted/self-hosted.mdx) section in
...
The one-line installation script does not generate a Teleport configuration file
for you. For this, we have a `teleport configure` CLI command or you can create
one manually.

See the following guides for help setting up a configuration file:

- [Teleport Configuration Reference](../../reference/deployment/config/config.mdx):
  This will provide you with the command you need to generate and populate the
  Teleport configuration file as well as further configuration options for your
  cluster.
- [Self-Hosted Demo
  Cluster](../self-hosted/self-hosted.mdx): If
  you are deploying the Teleport Auth Service and Proxy Service, read this guide
...
- [Self-Hosted Demo
  Cluster](../self-hosted/self-hosted.mdx): If you are
  deploying the Teleport Auth Service and Proxy Service, read this guide for an
  example of a configuration file.
- [Teleport Configuration Reference](../../reference/deployment/config/config.mdx): A guide to all
...
On cloud-hosted Teleport Enterprise you can visit a download page in the Web UI.
Select the user name in the upper right and select Downloads from the menu.

Customers who self-host Teleport Enterprise can access Enterprise downloads and their license
file from their [dedicated account dashboard](../self-hosted/license.mdx).
