...
teleport:
    ...
    ...
```
Review the [configuration reference](../../../reference/deployment/config/config.mdx) page for
additional settings.
...
```
Reference the [Auth Service configuration](../../../reference/deployment/config/config.mdx) reference page
...
Reference the [Proxy Service configuration](../../../reference/deployment/config/config.mdx) reference page
for additional settings.
