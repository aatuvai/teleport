...
- [Set the correct settings in /etc/teleport.yaml](../../../reference/deployment/config/config.mdx)
...
to a Teleport Auth Service instance. Follow the instructions in our [Trusted Clusters guide](../../../zero-trust-access/management/trustedclusters.mdx).
